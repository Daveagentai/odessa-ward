...
WITH lcr_members AS (
  SELECT * FROM jsonb_to_recordset('{esc(mem_json)}'::jsonb) AS x(
    ...
    is_sealed_to_parents boolean, ministering_brothers text, ministering_sisters text,
...
inserted AS (
  INSERT INTO members (
    ...
    is_sealed_to_current_spouse, is_sealed_to_parents, ministering_brothers,
  ...
  SELECT
    ...
    l.is_sealed_to_current_spouse, l.is_sealed_to_parents, l.ministering_brothers,
